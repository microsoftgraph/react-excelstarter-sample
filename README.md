...
languages:
- javascript
description: "This sample shows how to use the Microsoft Graph API to get a user's name and address and upload that information to an Excel file stored in OneDrive."
extensions:
  contentType: samples
  technologies:
  - Microsoft Graph
